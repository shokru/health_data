...
The full dataset (2012-2019) has over 3.3M rows.  
...
- the full dataset, 3.3M rows, 15 columns ([RData, 24Mo](/data/health_data.RData)) (CSV file too large to be uploaded in GitHub - available upon request) 
